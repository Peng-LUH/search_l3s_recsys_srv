pipeline {
    ...
    stages {
        ...
        stage('Git') {
            steps {
                cleanWs()
                git branch: 'main', url: 'https://github.com/e-Learning-by-SSE/search-l3s_recsys_service.git'
            }
        }
		...
		stage('Build') {
            steps {
                script {
                    ...
                    dockerImage = docker.build 'e-learning-by-sse/search-l3s_recsys_service'
