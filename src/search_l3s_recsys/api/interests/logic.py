...
class InterestRec(object):
    ...
    def recommend(self, user_id):
        ...
        for interest  in interests:   
            ...
            print(dir(gateway_searcher_api))
            response = gateway_searcher_api.get_search_service(user_id=1, query=interest, entity_type="all", num_results=2,owner = [1])
